...
use crate::{
    ...
    sinks::{lakesoul::sink::WriterSink, Healthcheck, VectorSink},
};
...
impl GenerateConfig for LakeSoulSinkConfig {
...
#[typetag::serde(name = "lakesoul")]
impl SinkConfig for LakeSoulSinkConfig {
...
mod tests {
    ...
    #[test]
    fn generate_config() {
        crate::test_util::test_generate_config::<LakeSoulSinkConfig>();
    }
}
